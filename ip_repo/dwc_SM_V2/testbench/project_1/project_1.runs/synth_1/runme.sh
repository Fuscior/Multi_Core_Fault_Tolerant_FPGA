...
HD_PWD='C:/Users/brenn/OneDrive/Desktop/Carlow/4thYear/Design_Project/2_0/dwc_SM_V2/testbench/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dwc_SM_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dwc_SM_tb.tcl
